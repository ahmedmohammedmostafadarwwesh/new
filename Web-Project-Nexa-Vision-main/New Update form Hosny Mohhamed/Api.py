...
from fastapi.middleware.cors import CORSMiddleware # تم إضافة هذا السطر
from pydantic import BaseModel

# ملفات الهاردوير الخاصة بالروبوت
import camira
import motor
import ultrasonic
import encoder
...
# =========================
# 🌍 إعدادات الـ CORS (هام جداً لربط واجهة الويب بالروبوت)
# =========================
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"], # يسمح للوحة التحكم بالاتصال من أي جهاز (لاب توب أو موبايل)
...
def get_distance():
    ...
    # حماية تلقائية: إذا كانت المسافة أقل من 20 سم، أوقف المواتير
    if d < 20:
        motor.stop()
